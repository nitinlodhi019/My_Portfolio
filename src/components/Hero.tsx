      ...
      <div className={`z-10 px-6 transition-all duration-1000 ${
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 max-w-6xl mx-auto">
          ...
          <div className="lg:w-2/3 space-y-8 text-center lg:text-left">
            ...
            <div className="text-xl md:text-2xl lg:text-3xl font-medium text-gray-700 dark:text-gray-300">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
              Passionate about transforming data into insights and building intelligent systems that solve real-world problems through machine learning and AI.
            </p>
