            ...
            <div className="space-y-6">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-500">
                <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                  Hi, I’m <span className="font-bold text-blue-600 dark:text-blue-400">Nitin Kumar</span> — an aspiring Data Scientist passionate about turning data into actionable insights. I specialize in machine learning, deep learning, and analytics, using Python and SQL to build predictive models and craft visual stories from data. Always learning, always exploring — excited to solve real-world challenges with data!
                </p>
              </div>
